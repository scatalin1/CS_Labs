...
public class Data {
    ...
    private String[] keyword = {"type", "description", "info", "Note", "Enabled", "Disabled", "Default on workstations and servers",
            "Default on domain controllers", "Default on workstations and servers", "Default",
            "Warning", "solution", "Policy Setting Name", "Name", "see_also", "value_type", "value_data",
            "right_type", "reg_key", "reg_item", "reg_option", "lockout_policy", "audit_policy_subcategory", "reference"};
